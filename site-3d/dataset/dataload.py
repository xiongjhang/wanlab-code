...
from siteflow.dataset.utils import default_prediction_collate
from siteflow.utils.util import get_logger, get_class
...
class SliceBuilder:
    ...
    def _build_slices(dataset, patch_shape, stride_shape):
        ...
        Returns:
            list of slices, i.e.
            [(slice[0: in_channels], slice, slice, slice), ...] if len(shape) == 4
